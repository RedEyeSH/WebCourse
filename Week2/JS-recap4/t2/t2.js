...
for (const restaurant of restaurants) {
  ...
  tr.addEventListener("click", () => {
    ...
    h3Name.innerHTML = restaurant.name;

    const pAddress = document.createElement("p");
    pAddress.innerHTML = "Address: " + restaurant.address;

    const pPostalCode = document.createElement("p");
    pPostalCode.innerHTML = "Postal Code: " + restaurant.postalCode;

    const pCity = document.createElement("p");
    pCity.innerHTML = "City: " + restaurant.city;

    const pPhoneNumber = document.createElement("p");
    pPhoneNumber.innerHTML = "Phone: " + restaurant.phone;

    const pCompany = document.createElement("p");
    pCompany.innerHTML = "Company: " + restaurant.company;

    const closeButton = document.createElement("button");
    closeButton.innerHTML = "Close";

    dialog.append(h3Name, pAddress, pPostalCode, pCity, pPhoneNumber, pCompany, closeButton);
    dialog.showModal();
  ...
  tdName.innerHTML = restaurant.name;

  const tdAddress = document.createElement("td");
  tdAddress.innerHTML = restaurant.address;
